...
_$PointRequestImpl _$$PointRequestImplFromJson(Map<String, dynamic> json) =>
    _$PointRequestImpl(
      ...
      normalPoints: (json['normalPoints'] as num?)?.toInt(),
      specialPoints: (json['specialPoints'] as num?)?.toInt(),
      totalPoints: (json['totalPoints'] as num?)?.toInt(),
      rateCalculatedAt: json['rateCalculatedAt'] == null
          ? null
          : DateTime.parse(json['rateCalculatedAt'] as String),
...
Map<String, dynamic> _$$PointRequestImplToJson(_$PointRequestImpl instance) =>
    <String, dynamic>{
      ...
      'normalPoints': instance.normalPoints,
      'specialPoints': instance.specialPoints,
      'totalPoints': instance.totalPoints,
      'rateCalculatedAt': instance.rateCalculatedAt?.toIso8601String(),
