...
class BadgeCreateView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BadgeCreateView> createState() => _BadgeCreateViewState();
}

class _BadgeCreateViewState extends ConsumerState<BadgeCreateView>
              ...
              Expanded(
                child: OutlinedButton(
                  onPressed: createState.isLoading ? null : () {
                    ref.read(badgeFormProvider.notifier).reset();
                    ref.read(badgeCreateProvider.notifier).reset();
                    _nameController.clear();
                    _descriptionController.clear();
                    _orderController.clear();
                    _requiredValueController.clear();
                    _jsonLogicController.clear();
  ...
  Future<void> _saveBadge(BadgeFormData formData, currentUser) async {
    ...
    final success = await ref.read(badgeCreateProvider.notifier).saveBadge(formData, currentUser.uid);
    
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('バッジを保存しました'),
